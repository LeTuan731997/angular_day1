...
export class ImageComponent implements OnInit {
    ...
    onClickZoom() {
        switch (this.currentInputSelect) {
            case "1":
                this.currentInputSelect = '2';
                this.onChange();
                break;
            case "2":
                this.currentInputSelect = '3';
                this.onChange();
                break;
            case "3":
                this.currentInputSelect = '4';
                this.onChange();
                break;
            case "4":
                this.currentInputSelect = '5';
                this.onChange();
                break;
            case "5":
                this.currentInputSelect = '6';
                this.onChange();
                break;
            case "6":
                this.currentInputSelect = '7';
                this.onChange();
                break;
            default:
                this.currentInputSelect = '7';
